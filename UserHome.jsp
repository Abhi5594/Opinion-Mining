					...
					<div class="navbar-collapse collapse">							
						<div class="menu">
							<ul class="nav nav-tabs" role="tablist">
								...
								<li role="presentation"><a href="View_Profile.jsp">Profile</a></li>
								<li role="presentation"><a href="Add_Post.jsp">Post</a></li>																
								<li role="presentation"><a href="View_Posts_Analysis.jsp">View All Posts</a></li>
